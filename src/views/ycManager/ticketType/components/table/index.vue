<template>
    <el-table :data="list" highlight-current-row border stripe style="width: 100%" @selection-change="selectChange">
        ...
        <el-table-column align="center" prop="typeName" label="门票类型" width="200">
        </el-table-column>
        <el-table-column align="center" prop="name" label="景点名称" width="250"></el-table-column>
        <el-table-column align="center" prop="price" label="价格" width="100"></el-table-column>
        <el-table-column align="center" prop="effectiveDay" label="有效期/（天）" width="150"></el-table-column>
